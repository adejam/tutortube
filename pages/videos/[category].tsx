...
const VideosCategory: React.FunctionComponent<videosCategoryProps> = ({
  data,
  category,
  error,
}): JSX.Element => {
  ...
  return (
    <div className="mw-1200 mx-auto mt-50">
      <h2 className="ta-center capitalize mt-10 mb-10">{category} Videos</h2>
          ...
          <div className="ta-center">
            {error ? (
              <>
                <h1>Ooops...</h1>
                <h2>
                  An Error Occurred. Check your internet connection and try
                  again later :(
                </h2>
              </>
            ) : (
